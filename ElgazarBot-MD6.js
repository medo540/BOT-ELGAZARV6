...
if (!text) return m.reply(`Example : ${prefix + command} Stay jb`)
        ...
        break    
        case 'XXXXXXXXXXXXX':case 'XXXXXXXXXXXXXX': {
    ...
    case 'XXXXXXXXXXXXXXX': case 'XXXXXXXXXXXXXXXXX':{
...
┗━━━━━━━━━❊`,
            ...
            break
case 'XXXXXXXXXXXXXXXXXX': case 'XXXXXXXXXXXXXXXXXXX': //credit: Ray Senpai ❤️ https://github.com/EternityBots/Nezuko
if (!text) throw `مثال : ${prefix + command} انمي ناروتو`
...
break
case 'XXXXXXXXXXXXXXXXXXXXX': case 'XXXXXXXXXXXXXXXXXXXXXXX': //credit: Ray Senpai ❤️ https://github.com/EternityBots/Nezuko
if(!text) throw `مثال : ${prefix + command} انمي ناروتو`
...
case 'بوت': {
            ...
            break
case 'الحب':
				if (!text) return m.reply(`منشن علي شخص, مثال : ${prefix + command} @black`)
...
ElgazarBot.sendMessage(from, { text: `*${command}*\n\nالاسم : ${q}\nالاجابه : *${tik}%*` }, { quoted: m })
					...
					case 'شخصيتك':
					if (!text) return m.reply(`منشن علي شخص, مثال : ${prefix + command} @black`)
					const xeony =['زفت','واطي','غبي','مطيع','غلبان','جدع','طيب','حبوب','جميل','حمار','محترم','لطيف','كلب','عيل']
...
𝙱𝙻𝙰𝙲𝙺 𝙱𝙾𝚃²⁰²³ https://wa.me/+201150137726
تابعني عبر روم الواتساب ⤌⤈
https://chat.whatsapp.com/Kpp6JufmBHY69ocwPvl8eo
ادخل عشان تلاقي كل جديد وحاجات جامده كتير🔥`
let buttons = [
