...
تمت البرمجه بواسطه: ELZA3EM THOMAS`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
...
ElgazarBot.sendMessage(from, { text: `*${command}*\n\nالاسم : ${q}\nالاجابه : *${tik}%*` }, { quoted: m })
					...
					case 'شخصيتك':
					if (!text) return m.reply(`منشن علي شخص, مثال : ${prefix + command} @black`)
					const xeony =['زفت','واطي','غبي','مطيع','غلبان','جدع','طيب','حبوب','جميل','حمار','محترم','كيوت','كلب','ورع']
